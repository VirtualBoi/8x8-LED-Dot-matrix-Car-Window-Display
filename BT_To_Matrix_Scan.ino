...
//------------------------change settings
String your_default_phrase_here = "DEFUALT PHRASE";
int light_intensity = 8; //default brightness between 0 - 15
int movement_speed = 100; //default movement speed:

int movement_speed_step [6] {800, 300, 200, 100, 80, 50};

int DIN = 16;
int CS =  5; //8X8 Pins OLD
int CLK = 4;
/*
int DIN = 4;
int CS =  5; //8X8 Pins
